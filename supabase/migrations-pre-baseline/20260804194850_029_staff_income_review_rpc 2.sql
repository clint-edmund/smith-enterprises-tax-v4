...
is
'Returns a unified staff-only Income organizer review payload containing W-2, 1099-INT, and 1099-DIV detail records for the requested client and tax year.';
